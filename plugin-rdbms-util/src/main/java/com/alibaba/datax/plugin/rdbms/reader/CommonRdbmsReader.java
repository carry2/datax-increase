...
//            String querySql = readerSliceConfig.getString(Key.QUERY_SQL);
            ...
            String increasecolumn = readerSliceConfig.getString(Key.INCREASECOLUMN, null);
            ...
            if(StringUtils.isNotBlank(increasecolumn)){
                ...
                if(StringUtils.isNotBlank(where)){
                    where=where+" and "+increasecolumn+">"+"'"+andUpTime+"'";
                }else{
                    where=increasecolumn+">"+"'"+andUpTime+"'";
                }
            }
            String querySql = SingleTableSplitUtil.buildQuerySql(column, table, where);
            //支持自定义sql
            if(!StringUtils.isEmpty(readerSliceConfig.getString(Key.QUERY_SQL))){
                querySql=readerSliceConfig.getString(Key.QUERY_SQL);
            }
